...
python -m pip install streamlit opencv-python opencv-contrib-python torch torchvision kornia requests pillow numpy git+https://github.com/<DEIN-USER>/pytorch-hed@v0.5.1
:req_ok
